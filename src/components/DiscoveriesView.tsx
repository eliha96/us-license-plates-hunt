  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex bg-slate-100 p-1 rounded-2xl ring-1 ring-slate-200">
        ...
        >
          {language === 'he' ? `מדינות (${foundCount}/50)` : `States (${foundCount}/50)`}
        </button>
        <button
          type="button"
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                language === 'he'
                  ? 'חפש מדינה (קליפורניה, CA, טקסס...)'
                  : 'Search by state name or code (CA, Texas)...'
              }
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {language === 'he' ? `נמצאו (${foundCount})` : `Found (${foundCount})`}
            </button>
            <button
              type="button"
            ...
            >
              {language === 'he' ? `חסרות (${50 - foundCount})` : `Missing (${50 - foundCount})`}
            </button>
          </div>
          ...
          {filteredStates.length === 0 && (
            <div className="text-center py-10 text-slate-400">
              <p className="text-sm font-bold">
                {language === 'he' ? 'לא נמצאו מדינות' : 'No states match filter'}
              </p>
            </div>
          )}
        </div>
